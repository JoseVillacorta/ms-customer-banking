...
public class CustomerHandler {
    ...
    public Mono<ServerResponse> findAll(ServerRequest request){
        return customerService.findAll()
                ...
                .flatMap(customers -> ServerResponse.ok()
                        ...
                        .bodyValue(ApiResponse.success(customers, "Ok", HttpStatus.OK.value()))
                );
    }
    ...
    public Mono<ServerResponse> findById(ServerRequest request){
        ...
        return customerService.findById(id)
                ...
                .switchIfEmpty(ServerResponse.status(HttpStatus.NOT_FOUND)
                        .bodyValue(ApiResponse.error("Customer not found", HttpStatus.NOT_FOUND.value())));
    }
    ...
    public Mono<ServerResponse> create(ServerRequest request){
        return request.bodyToMono(Customer.class)
                ...
                .flatMap(c -> ServerResponse
                        ...
                        .contentType(MediaType.APPLICATION_JSON)
                        .bodyValue(ApiResponse.success(c, "Customer created successfully", HttpStatus.CREATED.value())));
    }
    ...
    public Mono<ServerResponse> update(ServerRequest request){
        ...
        return request.bodyToMono(Customer.class)
                ...
                .flatMap(c -> ServerResponse.ok()
                        .contentType(MediaType.APPLICATION_JSON)
                        .bodyValue(ApiResponse.success(c, "Customer updated successfully", HttpStatus.OK.value())))
                .switchIfEmpty(ServerResponse.status(HttpStatus.NOT_FOUND)
                        .bodyValue(ApiResponse.error("Customer not found", HttpStatus.NOT_FOUND.value())));
    }
        ...
        return customerService.findById(id)
                .flatMap(c -> customerService.delete(id)
                    .then(ServerResponse.ok()
                            .contentType(MediaType.APPLICATION_JSON)
                            .bodyValue(ApiResponse.success(null, "Customer deleted successfully", HttpStatus.OK.value()))))
                .switchIfEmpty(ServerResponse.status(HttpStatus.NOT_FOUND)
                        .bodyValue(ApiResponse.error("Customer not found", HttpStatus.NOT_FOUND.value())));
    }
}
